      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm mt-1">
            Crea contenido visual increíble
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 p-8">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-slate-200 dark:border-slate-700 rounded-lg text-sm font-medium text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
            >
            ...
            <div className="relative my-5">
              ...
              <div className="relative flex justify-center text-xs text-slate-400">
                <span className="bg-white dark:bg-slate-800 px-3">{t('auth.orEmail')}</span>
              </div>
            </div>
